...
GEMINI_WRITER_MODEL = os.getenv("GEMINI_WRITER_MODEL", "gemini-flash-lite-latest")
GEMINI_PUBLISHER_MODEL = os.getenv("GEMINI_PUBLISHER_MODEL", "gemini-flash-lite-latest")
